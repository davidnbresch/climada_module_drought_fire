function bf=bf_generator_small_DEV(number_years,store_intensity_field)
...
%   --> USE bf_generator_small FOR THE TIME BEING (and bf_TEST to get started)
%
...
% Parameters
%
if isempty(number_years),         number_years         = 0.01;end
...
bf_file = [climada_global.data_dir filesep 'hazards' filesep 'external_model_output' filesep 'AUS_BF_proto_data.mat'];
%
% DOMAIN
...
fprintf('Simulated number of fires: %i',length(bf));
fprintf('Observed number of cells burnt : %i',set_cells_burnt);
fprintf('Simulated number of cells burnt: %i',cells_burnt);
